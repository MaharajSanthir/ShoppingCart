...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="ShoppingCartDataSource" Width="700px" CellPadding="4" HorizontalAlign="Center" style="text-align: center" DataKeyNames="cat_id" ForeColor="#333333" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" GridLines="None" AllowPaging="True">
